...
/**
 * This data type defines a generic functionality to register remote objects in the local registry
 * service. Communication is based in Java RMI.
 */
public class RegisterRemoteObject implements RegisterInterface {
     ...
     * reference. If a previous binding for the specified name exists, it is discarded.
     *
     * @param name the name to associate with the remote reference
     * @param ref reference to the remote object
     *
